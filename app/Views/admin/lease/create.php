...
<div class="card shadow-sm">
    <div class="card-header bg-white d-flex justify-content-between align-items-center py-3">
        <h5 class="mb-0">Add New Lease</h5>
    ...
    <div class="card-body">
        ...
        <form action="/admin/lease/create" method="POST">
            <?= csrf_field() ?>
            <div class="row g-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="property_id" class="form-select" required>
                            ...
                            <?php foreach($properties as $prop): ?>
                                <option value="<?= esc($prop['property_id']) ?>" <?= old('property_id') == $prop['property_id'] ? 'selected' : '' ?>>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="unit_id" class="form-select" required>
                            ...
                            <?php foreach($units as $unit): ?>
                                <option value="<?= esc($unit['unit_id']) ?>" <?= old('unit_id') == $unit['unit_id'] ? 'selected' : '' ?>>
                                    <?= esc($unit['unit_name']) ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" step="0.01" class="form-control" name="rent_amount" value="<?= old('rent_amount') ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <span class="input-group-text">$</span>
                            <input type="number" step="0.01" class="form-control" name="deposit_amount" value="<?= old('deposit_amount') ?>">
                        </div>
                    </div>
